...
const TAG_PREFIX = 'v';
const WORKFLOW_NAME = 'Release App';
...
function usage(msg) {
  ...
  console.error('Usage: node scripts/release.cjs [<version>|patch|minor|major]');
...
function main() {
  ...
  // 版本以根 package.json 为准（tauri.conf.json 的 version 指向 ../../../package.json）
